...
void send_data_to_UWP_app(wchar_t* data, uint32_t length, wchar_t* service_name, wchar_t* pkg_family_name)
{
    ...
    newConnection->AppServiceName = ref new Platform::String(service_name);
    newConnection->PackageFamilyName = ref new Platform::String(pkg_family_name);
